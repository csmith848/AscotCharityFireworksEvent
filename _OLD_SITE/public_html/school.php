            ...
            <td align="center">
              ...
              Adults &pound;<?php echo $adultAdv; ?>, Children &pound;<?php echo $childAdv; ?>, under 5 free
				...
				<table width="90%">
					...
					<tr><td>Whitegrove Primary School</td><td>whitegrove</td></tr>
					<tr><td>Warfield CofE - All Saints</td><td>allsaints</td></tr>
					<tr><td>Warfield CofE - Woodhurst</td><td>woodhurst</td></tr>
				</table>
				</p>
